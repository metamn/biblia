<?php 
/**template name: Causes Search Results
 * The causes search results template file.
 *
 * @package WordPress
			...
			<div class="row">
				...
				<div class="col-md-8">
					...
					<?php 
						...
						$temp_query = $wp_query;
						$wp_query = $cause_search_object->query();
						...
						$percents = 0;
						$cause_donation_goal = (float)rwmb_meta('core_cause_goal');
					...
					<?php endwhile; 
						...
						<div class="col-md-12 box-content">
							<p><?php _e('Nothing Found. Try another search criteria.', CORE_THEME_NAME); ?></p>
						</div> <!-- /.col-md-12 -->
