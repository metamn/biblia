<?php 
/**template name: Causes 3 Cols
 * The causes 3cols template file.
 *
 * @package WordPress
		...
		<div class="container">
			...
			<div class="row">
				<?php
			        ...
			        $wp_query = new WP_Query(array( 'post_type' => 'cause', 'order' => 'DESC', 'orderby' => 'date', 'posts_per_page' => 6, 'paged' => $paged ));
				...
				<div class="col-md-4 col-sm-6 cause-grid">
					...
					<div class="cause-thumb">
						<?php the_post_thumbnail('cause-thumb'); ?>
