<?php 
/**template name: Causes 4 Cols
 * The causes 4 cols template file.
 *
 * @package WordPress
		...
		<div class="container">
			...
			<div class="row">
				<?php
			        ...
			        $wp_query = new WP_Query(array( 'post_type' => 'cause', 'order' => 'DESC', 'orderby' => 'date', 'posts_per_page' => 8, 'paged' => $paged ));
